...
object QuaternionDAL extends DAL {
  ...
  operation(
    ...
    QuaternionRationalType -> ((l: Number, r: Number) =>
      maybeDemote(toQuaternionRational(l) + toQuaternionRational(r))
    ),
    QuaternionDoubleType -> ((l: Number, r: Number) =>
      (QuaternionDoubleType, toQuaternionDouble(l) + toQuaternionDouble(r))
    ),
    QuaternionBigDecType -> ((l: Number, r: Number) =>
      (QuaternionBigDecType, toQuaternionBigDecimal(l) + toQuaternionBigDecimal(r))
    ),
  )
  ...
  operation(
    ...
    QuaternionBigIntType -> ((l: Number, r: Number) =>
      (QuaternionDoubleType, toQuaternionDouble(l) / toQuaternionDouble(r))
    ),
    QuaternionRationalType -> ((l: Number, r: Number) =>
      (QuaternionDoubleType, toQuaternionDouble(l) / toQuaternionDouble(r))
